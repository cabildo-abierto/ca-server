...
export interface ViewerState {
  $type?: 'ar.cabildoabierto.feed.defs#viewerState'
  repost?: string
  like?: string
  threadMuted?: boolean
...
export interface ThreadContext {
  $type?: 'ar.cabildoabierto.feed.defs#threadContext'
...
export interface ReasonPin {
  $type?: 'ar.cabildoabierto.feed.defs#reasonPin'
}
...
export interface ThreadViewPost {
  $type?: 'ar.cabildoabierto.feed.defs#threadViewPost'
  post: PostView
  parent?:
...
export interface NotFoundPost {
  $type?: 'ar.cabildoabierto.feed.defs#notFoundPost'
  uri: string
  notFound: true
}
...
export interface BlockedPost {
  $type?: 'ar.cabildoabierto.feed.defs#blockedPost'
  uri: string
  blocked: true
...
export interface BlockedAuthor {
  $type?: 'ar.cabildoabierto.feed.defs#blockedAuthor'
  did: string
...
export interface GeneratorView {
  $type?: 'ar.cabildoabierto.feed.defs#generatorView'
  uri: string
  cid: string
  did: string
...
export interface GeneratorViewerState {
  $type?: 'ar.cabildoabierto.feed.defs#generatorViewerState'
  like?: string
}
...
export interface ThreadgateView {
  $type?: 'ar.cabildoabierto.feed.defs#threadgateView'
  uri?: string
  cid?: string
  record?: { [_ in string]: unknown }
...
export interface Interaction {
  $type?: 'ar.cabildoabierto.feed.defs#interaction'
  item?: string
  event?:
